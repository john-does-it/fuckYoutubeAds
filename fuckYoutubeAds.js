...
(function () {
  ...
  function hideAdsSlot () {
    ...
    const youTubeAdsWatchFeed3 = document.querySelector('panel-ad-header-image-lockup-view-model')
    ...
    if (youTubeAdsWatchFeed3) {
      youTubeAdsWatchFeed3.style.display = 'none'
    }
